package {
    ...
    public class MediaAudioVideo {
        ...
        public function play(dummyCallback:Function = null):void {
            ...
            if (frontStream === STREAM_STATE_BUFFERING ||
                rearStream === STREAM_STATE_BUFFERING) {
                return;
            }
...
//                _boss.postMessage("playing", _id); // W3C NamedEvent
        ...
        public function isBusy():Boolean {
            ...
            state = _boss.judgeMultipleStreamState(
                        _frontMedia.getState().streamState[0],
                        _rearMedia.getState().streamState[0]);

            return state === STREAM_STATE_BUFFERING;
        }
    }
}
