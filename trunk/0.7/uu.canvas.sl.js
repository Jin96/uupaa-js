    ...
    if (style._colorStop.length) {
      ...
      if (v.color[1] > 0.001) {
        ...
        bari =  [ _SL_PATH_OPACITY, me[_GLOBAL_ALPHA],
                  ...
                  _HEX2[parseFloat(v.color[1] / (1 / 255))] +
...
function _buildRadialColor(style) {
  ...
  rv.push('<GradientStop Color="#',
            _HEX2[parseFloat(style._colorStop[0].color[1] / n)],
