...
uu.log("mousedown: gesture=@ touches=@", evt.gesture, evt.touches ? evt.touches.length : 0);
...
uu.log("mouseup: gesture=@ touches=@", evt.gesture, evt.touches ? evt.touches.length : 0);
        if (evt.gesture) {
            uu.unbind(doc, "gesturechange+,gestureend+", this);
