...
var _uuguid = "data-uuguid",
    ...
    _FILTERS = {
        ...
        link:               [0x0e, visitedFilter],
        visited:            [0x0f, visitedFilter],
...
uu.query.childFilter = childFilter;
uu.query.filters     = _FILTERS;
...
function selectorAll(expr,      // @param CSSQueryString: expr
    ...
    _tags = _ctype === 1 ? _htmltagdb : _xhtmltagdb;
...
function addTag(tag, contentType) {
    ...
    lo in _htmltagdb || (_xhtmltagdb[up] = _htmltagdb[lo] = _htmltagdb[up] = up,
                         _xhtmltagdb[lo] = lo);
    // IE unsupported HTML5 tags
